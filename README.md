...
> 提醒： Heroku 已经封禁本专案，请 Fork 本专案后，将 README.md 中的xlzh0330ggnn/7bafaff替换为自己的用户名后/仓库名，再进行部署。
...
* 使用[xray](https://github.com/xlzh0330ggnn/7bafaff)+caddy同时部署通过ws传输的vmess vless trojan shadowsocks socks等协议，并默认已配置好伪装网站。
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/xlzh0330ggnn/7bafaff) 
